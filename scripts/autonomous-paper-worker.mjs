...
const WORKSTREAMS = [
  ...
  ["zero-dte:reconcile", ["--format=json"]],
  ["research:daily", ["--riskProfile=aggressive", "--optionsEnabled=true", "--excludeZeroDte=true", `--maxCandidates=${PAPER_EXPLORATION_MAX_CANDIDATES}`, "--assetClass=all", "--format=json"]],
